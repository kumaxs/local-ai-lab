...
Docling Service 1.0.2 is distributed from the Git tag `v1.0.2`. The tag starts
...
- `docling-service-1.0.2.tar.gz` or `docling-service-1.0.2.zip`;
...
`~/Library/Application Support/Local AI Lab/docling-service/1.0.2`. The Python
