...
Tab.3 Experimental environments

| 实验环境  操作系统  CPU  GPU  参数  实验环境  Windows 11  Python  Intel Core i9-9900K  PyTorch  CPU@3.60 GHz  NVIDIA GeForce RTX 3080 Ti  内存  参数  3.10  1.10.2  64 GB   |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
...
图5 不同模型的AUC 值 Fig.5 AUC value of different models

<!-- image -->

图6 不同模型的ACC 值 Fig. 6 ACC value of different models
...
Fig.7 Comparison of iterations for each model
...
Tab.6 Comparison of accuracy in intelligent learning environment

| 模型  指标  DKT  TCN-KT  DKVMN  CKT  SKT  TSKT  ACC  0.726  0.765  0.724  0.793  0.782  0.801   |
|---------------------------------------------------------------------------------------------|
